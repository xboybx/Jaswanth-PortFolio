          ...
          <motion.div variants={itemVariants} className="space-y-6">
            <div className="prose prose-lg text-text-primary">
              ...
              <p className="mb-6 text-lg leading-relaxed">
                ...
                user authentication systems to comprehensive student management
                platforms. I believe in writing clean, maintainable code and
                staying updated with the latest industry trends.
              </p>
              <p className="text-lg leading-relaxed">
                When I'm not coding, you'll find me exploring new technologies,
                contributing to open-source projects, and pursuing my passion
                for music creation.
              </p>
            </div>
          </motion.div>

          <motion.div variants={itemVariants} className=" lg:grid grid-cols-2 ">
