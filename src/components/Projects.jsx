...
const projects = [
  {
    title: "CHAT-DB — Natural-Language Data Explorer",
    description:
      "Full-stack app to query databases in plain English using Gemini AI, supporting CSV/Excel uploads and direct DB connections.",
    image: "https://ik.imagekit.io/mtkm3escy/Screenshot%20(257).png",
    tags: ["Next.js 13", "React 18", "Tailwind CSS", "Supabase", "Gemini AI"],
    longDescription:
      "CHAT-DB is a Gemini-powered data explorer that lets users query data using natural language instead of writing SQL or MongoDB queries. Users can upload Excel/CSV files or connect to live MongoDB/SQL databases, then see both the generated query and the results for full transparency.",
    githubUrl: "https://github.com/xboybx/ChatDB.git",
    liveUrl: "https://chat-db-opal.vercel.app/",
  },

  {
    title: "COLLAB-SPHERE — AI-Enhanced Project Rooms",
    description:
      "Collaboration platform with private project rooms, AI chat assistance, and real-time communication for developers.",
    image: "https://ik.imagekit.io/mtkm3escy/Screenshot%20(258).png",
    tags: ["React.js", "Tailwind CSS", "Express.js", "Socket.io", "AI"],
    longDescription:
      "Collab-Sphere is a developer-focused collaboration platform that provides private project rooms with integrated AI assistance. Teams can chat in real time, ask AI for code suggestions or debugging help, and keep discussions organized around specific projects.",
    githubUrl: "https://github.com/xboybx/CollabSphere.git",
    liveUrl: "https://collabsphere-client.onrender.com/",
  },
  {
    title: "SECURE-DOCS — Secure Digital Document Storage",
    description:
      "Secure platform for storing and managing important documents with encryption, authentication, and role-based access.",
    image:
      "https://cdn.prod.website-files.com/6253c9670ce32763514ecb3c/6541d32e1802bdee9e6408c9_Digilocker%20Animation_Final%20(1)-poster-00001.jpg",
    tags: ["MongoDB", "Express.js", "React.js", "Node.js", "JWT"],
    longDescription:
      "SECURE-DOCS is a secure digital document storage system that lets users upload, organize, and manage sensitive documents online. It focuses on encryption, robust authentication, and role-based access control to ensure only authorized users can access or modify documents.",
    githubUrl: "https://github.com/xboybx/Secure-Docs.git",
    liveUrl: "https://secure-docs-client.onrender.com/",
  },
  {
    title: "LINK-MINT — Custom Name Link Shortener",
    description:
      "Custom URL shortener that generates branded, trackable short links with analytics for businesses and creators.",
    image:
      "https://www.shutterstock.com/image-vector/url-shortener-male-user-compresses-600nw-2213913815.jpg",
    tags: ["React.js", "Tailwind CSS", "Express.js", "MongoDB"],
    longDescription:
      "Link-Mint is a URL shortener that focuses on branding and tracking. Users can create custom aliases, track click analytics, and manage link collections, making it ideal for marketing campaigns and personal branding.",
    githubUrl: "https://github.com/xboybx/Custom-Url-Shortner.git",
    liveUrl: "https://custom-url-shortner-client.onrender.com/",
  },
  {
    title: "SUPER-MALL — Advertising E-Commerce for Mall Vendors",
    description:
      "Advertising-focused e-commerce platform that helps mall vendors showcase products and run targeted campaigns.",
    image:
      "https://static.vecteezy.com/system/resources/thumbnails/003/418/039/small/shopping-mall-illustration-vector.jpg",
    tags: ["React.js", "Tailwind CSS", "Express.js", "MongoDB"],
    longDescription:
      "Super-Mall is an advertising-centric e-commerce platform designed for mall vendors. Vendors get dashboards to manage product catalogs, schedule campaigns, and improve visibility, while customers can browse featured products and offers.",
    githubUrl: "https://github.com/xboybx/SuperMall-WebApplication-UM.git",
    liveUrl: "https://supermall-webapplication-um.onrender.com/",
  },
];
