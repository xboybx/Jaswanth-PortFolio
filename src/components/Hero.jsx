...
function Hero() {
  ...
  return (
    <div className="relative min-h-screen">
      {/* Lanyard Overlay - Full Hero Section Coverage */}
      <div className="absolute inset-0 z-[100] pointer-events-auto lg:left-1/2 lg:w-1/2">
        <Suspense
          fallback={
      ...
      <motion.div
        ...
        className="relative z-[50] min-h-screen flex items-center justify-center px-6 lg:px-16 lg:pt-20"
      >
        <div className="max-w-7xl mx-auto flex flex-col lg:grid lg:grid-cols-2 gap-12 items-center lg:items-start">
          {/* Content Section */}
          <motion.div
            variants={itemVariants}
            className="space-y-6 text-center lg:text-left order-2 lg:order-1 lg:mt-16"
          >
          ...
          <div className="hidden lg:block order-1 lg:order-2">
            {/* This div provides space for the lanyard on desktop */}
          </div>
        </div>
      </motion.div>
    </div>
